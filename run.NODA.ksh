...
datadir="/scratch4/NCEPDEV/stmp3/Donald.E.Lippi/fv3gfs_dl2rw/2018091100/NODA-2018091100-2018091800/gfs.20180911/00"
pdy=20180911
cyc=00
set -x
FHSTART=72
...
while [[ $FH -le $FHEND ]]; do
   ...
   cd /scratch4/NCEPDEV/stmp3/Donald.E.Lippi/fv3gfs_dl2rw/2018091100/NODA-2018091100-2018091800/gfs.20180911/00
   ...
   python threaded_fv3_2d_GLOBE.py gfs.t00z.atmf${FH}.nc4 $datadir $pdy $cyc $valpdy $valcyc $valtime $FH
    echo $FH
   (( FH=$FH+$FHINC ))
